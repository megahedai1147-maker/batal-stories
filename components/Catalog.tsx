...
const stories: Story[] = [
  ...
  // ══ آداب عامة ══
  { id:61, gender:'boy', category:'آداب عامة', title:'بطل الطابور', emoji:'🚶', bg:'linear-gradient(135deg,#12284C,#1E3A6E)', desc:'طفلنا يتعلم قيمة الانتظار في الطابور باحترام وصبر مع أصدقائه', moral:'النظام والصبر', hasImage:false },
  { id:62, gender:'girl', category:'آداب عامة', title:'الكلمة الطيبة', emoji:'💬', bg:'linear-gradient(135deg,#1E3A6E,#27D3B6)', desc:'طفلتنا تكتشف كيف كلمة طيبة واحدة ممكن تغير يوم حد كامل', moral:'اللطف', hasImage:false },
  { id:63, gender:'boy', category:'آداب عامة', title:'شكرًا... تصنع السعادة', emoji:'🙏', bg:'linear-gradient(135deg,#12284C,#FFC72C)', desc:'طفلنا يتعلم إن كلمة شكرًا الصغيرة بتنشر سعادة كبيرة حواليه', moral:'الامتنان', hasImage:false },
  { id:64, gender:'girl', category:'آداب عامة', title:'أستأذن أولًا', emoji:'🤲', bg:'linear-gradient(135deg,#1E3A6E,#7B3FF2)', desc:'طفلتنا تتعلم أدب الاستئذان قبل أخذ أي حاجة من حد', moral:'الاحترام', hasImage:false },
  { id:65, gender:'boy', category:'آداب عامة', title:'البطل الذي يساعد الجميع', emoji:'🤝', bg:'linear-gradient(135deg,#12284C,#27D3B6)', desc:'طفلنا يكتشف إن مساعدة الآخرين بتخليه بطل حقيقي في عيون الجميع', moral:'التعاون', hasImage:false },
  { id:66, gender:'boy', category:'آداب عامة', title:'بطل الحديقة النظيفة', emoji:'🌳', bg:'linear-gradient(135deg,#27D3B6,#12284C)', desc:'طفلنا يقود حملة للحفاظ على نظافة الحديقة ويصبح قدوة لأصحابه', moral:'حب البيئة', hasImage:false },
  { id:67, gender:'girl', category:'آداب عامة', title:'الفصل النظيف', emoji:'🧹', bg:'linear-gradient(135deg,#1E3A6E,#FFC72C)', desc:'طفلتنا تتعلم أهمية النظام والنظافة في فصلها مع زميلاتها', moral:'النظام', hasImage:false },
  { id:68, gender:'girl', category:'آداب عامة', title:'لا للتنمر... نعم للصداقة', emoji:'🚫', bg:'linear-gradient(135deg,#12284C,#FF2D7A)', desc:'طفلتنا تقف في وجه التنمر وتنشر روح الصداقة بين زميلاتها', moral:'رفض التنمر', hasImage:false },
  { id:69, gender:'boy', category:'آداب عامة', title:'آداب تناول الطعام', emoji:'🍽️', bg:'linear-gradient(135deg,#1E3A6E,#FF7A1A)', desc:'طفلنا يتعلم آداب المائدة الصحيحة ويطبقها بفخر أمام أسرته', moral:'آداب الطعام', hasImage:false },
  { id:70, gender:'boy', category:'آداب عامة', title:'السلام بداية الصداقة', emoji:'👋', bg:'linear-gradient(135deg,#12284C,#27D3B6)', desc:'طفلنا يكتشف إن كلمة السلام هي أول خطوة لصداقة جميلة', moral:'حسن الاستقبال', hasImage:false },
  { id:71, gender:'girl', category:'آداب عامة', title:'غرفتي مسؤوليتي', emoji:'🛏️', bg:'linear-gradient(135deg,#1E3A6E,#FF2D7A)', desc:'طفلتنا تتحمل مسؤولية ترتيب غرفتها وتفخر بنظامها الجديد', moral:'المسؤولية', hasImage:false },
  { id:72, gender:'boy', category:'آداب عامة', title:'الاستئذان قبل الدخول', emoji:'🚪', bg:'linear-gradient(135deg,#12284C,#7B3FF2)', desc:'طفلنا يتعلم أدب طرق الباب والاستئذان قبل دخول أي غرفة', moral:'الاحترام', hasImage:false },
  { id:73, gender:'girl', category:'آداب عامة', title:'أحافظ على أدواتي', emoji:'🎒', bg:'linear-gradient(135deg,#1E3A6E,#FFC72C)', desc:'طفلتنا تتعلم قيمة المحافظة على أدواتها وألعابها بحرص', moral:'المحافظة على الممتلكات', hasImage:false },
  { id:74, gender:'boy', category:'آداب عامة', title:'أساعد زملائي', emoji:'🧑‍🤝‍🧑', bg:'linear-gradient(135deg,#12284C,#27D3B6)', desc:'طفلنا يمد يد العون لزميله في الفصل ويكتشف فرحة العطاء', moral:'التعاون', hasImage:false },
  { id:75, gender:'girl', category:'آداب عامة', title:'كلمة سحرية اسمها من فضلك', emoji:'✨', bg:'linear-gradient(135deg,#1E3A6E,#FF2D7A)', desc:'طفلتنا تكتشف السحر الحقيقي في كلمة من فضلك مع كل طلب', moral:'حسن الطلب', hasImage:false },
  // ══ أبطال ══
  { id:76, gender:'boy', category:'أبطال', title:'البطل الخارق الشجاع', emoji:'🦸', bg:'linear-gradient(135deg,#E4572E,#FF7A1A)', desc:'طفلنا يكتشف بطولته الحقيقية في موقف يحتاج شجاعة نادرة', moral:'الشجاعة', hasImage:false },
  { id:77, gender:'boy', category:'أبطال', title:'قوة القلب الطيب', emoji:'💖', bg:'linear-gradient(135deg,#E4572E,#FF2D7A)', desc:'طفلنا يتعلم إن أقوى سلاح هو القلب الطيب مش القوة', moral:'الطيبة قوة', hasImage:false },
  { id:78, gender:'boy', category:'أبطال', title:'بطل لا يستسلم', emoji:'🏆', bg:'linear-gradient(135deg,#E4572E,#FFC72C)', desc:'طفلنا يواجه تحدي صعب ويتعلم إن الأبطال الحقيقيين ما بيستسلموش', moral:'المثابرة', hasImage:false },
  { id:79, gender:'boy', category:'أبطال', title:'درع الشجاعة', emoji:'🛡️', bg:'linear-gradient(135deg,#E4572E,#12284C)', desc:'طفلنا يحمل درع الشجاعة ليحمي من حوله في مغامرة مثيرة', moral:'الشجاعة', hasImage:false },
  { id:80, gender:'boy', category:'أبطال', title:'مهمة إنقاذ المدينة', emoji:'🏙️', bg:'linear-gradient(135deg,#E4572E,#7B3FF2)', desc:'طفلنا في مهمة خطيرة لإنقاذ مدينته بالذكاء والشجاعة', moral:'التضحية', hasImage:false },
  { id:81, gender:'boy', category:'أبطال', title:'البطل الذي هزم الخوف', emoji:'😤', bg:'linear-gradient(135deg,#E4572E,#27D3B6)', desc:'طفلنا يواجه أكبر مخاوفه ويكتشف إنه أقوى مما يتخيل', moral:'مواجهة الخوف', hasImage:false },
  { id:82, gender:'boy', category:'أبطال', title:'قوة الإرادة الخارقة', emoji:'⚡', bg:'linear-gradient(135deg,#E4572E,#FFC72C)', desc:'طفلنا يحقق المستحيل بإرادته القوية وإصراره على النجاح', moral:'قوة الإرادة', hasImage:false },
  { id:83, gender:'boy', category:'أبطال', title:'البطل الصغير في مواجهة التنمر', emoji:'🦸‍♂️', bg:'linear-gradient(135deg,#E4572E,#FF2D7A)', desc:'طفلنا يقف بشجاعة في وجه التنمر ويدافع عن نفسه وأصحابه', moral:'الشجاعة في الدفاع عن النفس', hasImage:false },
  // ══ أميرات ══
  { id:84, gender:'girl', category:'أميرات', title:'أميرة الأحلام', emoji:'👑', bg:'linear-gradient(135deg,#D6336C,#7B3FF2)', desc:'طفلتنا أميرة تسافر في عالم الأحلام لتحقق أمنيتها الغالية', moral:'تحقيق الأحلام', hasImage:false },
  { id:85, gender:'girl', category:'أميرات', title:'أميرة اليونيكورن', emoji:'🦄', bg:'linear-gradient(135deg,#D6336C,#27D3B6)', desc:'طفلتنا تصادق يونيكورن سحري في مغامرة مليئة بالألوان والسحر', moral:'الخيال', hasImage:false },
  { id:86, gender:'girl', category:'أميرات', title:'أميرة الفراشات', emoji:'🦋', bg:'linear-gradient(135deg,#D6336C,#FFC72C)', desc:'طفلتنا أميرة تحكم مملكة الفراشات الملونة بقلب طيب وحنون', moral:'الجمال الداخلي', hasImage:false },
  { id:87, gender:'girl', category:'أميرات', title:'أميرة الزهور', emoji:'🌸', bg:'linear-gradient(135deg,#D6336C,#FF7A1A)', desc:'طفلتنا أميرة تنشر الجمال في مملكتها بحديقة ورد سحرية', moral:'العطاء', hasImage:false },
  { id:88, gender:'girl', category:'أميرات', title:'أميرة القمر', emoji:'🌙', bg:'linear-gradient(135deg,#D6336C,#12284C)', desc:'طفلتنا أميرة تحرس نور القمر وتضيء الليل لكل الأطفال', moral:'الحلم', hasImage:false },
  { id:89, gender:'girl', category:'أميرات', title:'أميرة النجوم', emoji:'⭐', bg:'linear-gradient(135deg,#D6336C,#FFC72C)', desc:'طفلتنا أميرة تجمع النجوم المتناثرة وتعيدها لسماء مملكتها', moral:'الطموح', hasImage:false },
  { id:90, gender:'girl', category:'أميرات', title:'أميرة الكريستال', emoji:'💎', bg:'linear-gradient(135deg,#D6336C,#27D3B6)', desc:'طفلتنا أميرة تحمي قصر الكريستال الساحر من قوى الظلام', moral:'النقاء', hasImage:false },
  { id:91, gender:'girl', category:'أميرات', title:'الأميرة والقلعة السرية', emoji:'🏰', bg:'linear-gradient(135deg,#D6336C,#12284C)', desc:'طفلتنا أميرة تكتشف قلعة سرية مخبأة تحمل أسرار مملكتها', moral:'الشجاعة والاكتشاف', hasImage:false },
  { id:92, gender:'girl', category:'أميرات', title:'أميرة البحر', emoji:'🧜‍♀️', bg:'linear-gradient(135deg,#D6336C,#27D3B6)', desc:'طفلتنا أميرة تحكم مملكة تحت الأمواج وتنقذ أصدقاءها البحريين', moral:'الشجاعة', hasImage:false },
  { id:93, gender:'girl', category:'أميرات', title:'أميرة مدينة الأحلام', emoji:'🌆', bg:'linear-gradient(135deg,#D6336C,#FF7A1A)', desc:'طفلتنا أميرة تبني مدينة أحلامها بالخيال والإبداع والحب', moral:'الأمل والإبداع', hasImage:false },
  { id:94, gender:'girl', category:'أميرات', title:'مدينة الأحلام الوردية', emoji:'🌷', bg:'linear-gradient(135deg,#D6336C,#FF2D7A)', desc:'طفلتنا أميرة تنشر الفرح والتفاؤل في مدينتها الوردية الساحرة', moral:'التفاؤل', hasImage:false },
]
